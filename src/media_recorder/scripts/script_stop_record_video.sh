...
# parameter #2 is file name suffix... file date.
# killing by file name used in start recording... that is why name should be unique.
...
echo -e $CMD
kill $(ps aux | grep "ffmpeg" | grep $DATE | awk '{print $2}')
